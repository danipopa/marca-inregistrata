class AddRenewalProductsAndRequestOptions < ActiveRecord::Migration[8.1]
  def change
    add_column :trademark_requests, :order_type, :string, null: false, default: "registration"
    add_column :trademark_requests, :owner_change_requested, :boolean, null: false, default: false
    ...
    reversible do |direction|
      ...
      direction.down do
        create_insertable_model.where(code: [
          "renew-ro-word",
          "renew-ro-monochrome",
          "renew-ro-color",
          "renew-eu-word",
